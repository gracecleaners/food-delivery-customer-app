...
// Safe snackbar helper methods
  ...
  Future<void> _handleGoogleAuthResponse(Map<String, dynamic> response,
      Map<String, dynamic> googleAuthData) async {
    try {
  ...
  Future<void> registerGoogleUser(Map<String, dynamic> registrationData) async {
    try {
      ...
      final response = await _apiService.postPublic(
          'users/auth/google/register/', requestBody);
  ...
  Future<void> registerUserWithGoogle(Map<String, dynamic> userData) async {
    try {
      ...
      final response =
          await _apiService.postPublic('users/auth/google/register/', userData);
